...
$getcategory= mysqli_query($connectiondb,$query);
...
<body>
    ...
    ***********************************-->
    ...
    <tr>
      ...
      <td><button class="btn btn-danger" name="deletauthor"><a href="categorydeleteaction.php?acceptId=<?php echo $row["category_id"]?> "class="text-light"> Delete </a></button></td>
