...
$query = 'select * from pending_author';
$getpendingauthor= mysqli_query($connectiondb,$query);
session_start();
require 'connectdb.php';
...
<body>
    ...
    ***********************************-->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Pending Author</h4>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
    <?php while($row= mysqli_fetch_assoc($getpendingauthor)){;?> 
    ...
    <tr>
      ...
      <td><?php echo $row['author_password'] ?></td>
      <td><?php echo $row['author_contact'] ?></td>
      <td><?php echo $row['author_role'] ?></td>
      <td><?php echo $row['author_img'] ?></td>
      <!-- <td><button class="btn btn-danger" name="deletauthor"><a href="authordeleteaction.php?acceptId=<?php echo $row["author_id"]?> "class="text-light"> Delete </a></button></td> -->
      
      <td><button class="btn btn-primary" name="approvedauthor"><a href="authorapprovedaction.php?acceptId=<?php echo $row["author_id"]?> "class="text-light"> Approved </a></button></td>
