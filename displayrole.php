...
$query = 'select * from web_roles';
$getrole= mysqli_query($connectiondb,$query);
...
<body>
    ...
    ***********************************-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
    <?php while($row= mysqli_fetch_assoc($getrole)){;?> 
    ...
    <tr>
      ...
      <td><button class="btn btn-danger" name="deletrole"><a href="roledeleteaction.php?acceptId=<?php echo $row["role_id"]?> "class="text-light"> Delete </a></button></td>
