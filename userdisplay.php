...
<body>
    ...
    ***********************************-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
    <?php while($row= mysqli_fetch_assoc($getuserinfo)){;?> 
    ...
    <tr>
      ...
      <td><button class="btn btn-danger" name="deletauthor"><a href="userdeleteaction.php?acceptId=<?php echo $row["user_id"]?> "class="text-light"> Delete </a></button></td>
