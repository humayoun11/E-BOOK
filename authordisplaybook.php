                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
    <?php $query = "select * from books_info where book_author = '$authorname' ";
$getbooks= mysqli_query($connectiondb,$query);
    ...
    <tr>
      ...
      <td><button class="btn btn-danger" name="authordeletbook"><a href="authordeletedeleteaction.php?acceptId=<?php echo $row["book_id"]?> "class="text-light"> Delete </a></button></td>
