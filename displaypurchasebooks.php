...
$queryr= "select * from user_info where user_id = $userid ";
$userdata = mysqli_query($connectiondb,$queryr);
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow" href="displaypurchasebooks.php" aria-expanded="false">
                            <i class="icon-envelope menu-icon"></i> <span class="nav-text">Display Purchase Books</span>
                    </a>
                    </li>
                    <!-- <li>
