...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="authorsubmitbookaction.php" method="POST" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Book Price <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="number" class="form-control" id="val-username"
                                                    name="bookprice" placeholder="Enter a book price.." required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-email">Book Name <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-email" name="bookname"
                                                    placeholder="book name" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-password">Book Author <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-password"
                                                    name="bookauthor" placeholder="Choose a safe one.." required value="<?php echo $row['author_name']?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label"
                                                for="val-confirm-password">Release_ Date<span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="date" class="form-control" id="val-confirm-password"
                                                    name="releasedate" placeholder="..and confirm it!" required>
                                            </div>
                                        </div>
                                        <!-- <div class="form-group row">
      ...
      <?php
        $queryr= "select * from books_category";
        ...
        ?>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-currency">Book Img <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="file" name="book_image" class="form-control" id="val-currency">
                                                
                                            </div>
                                       
                                        </div>
                                        <!-- <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-currency">Book File <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="file" name="book_image" class="form-control" id="val-currency">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-8 ml-auto">
                                                <button type="submit" name="booksubmitaction" class="btn mb-1 btn-rounded btn-primary">Submit</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
