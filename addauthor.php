                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="addroleaction.php" method="POST">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Author Name <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username"
                                                name="authorname" placeholder="Enter a author name.." required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-email">Author Email <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-email" name="autoremail"
                                                    placeholder="author valid email..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-password">Author Password <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="password" class="form-control" id="val-password"
                                                    name="authorpassword" placeholder="Choose a safe one..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="numer" class="form-control" id="val-confirm-password"
                                                    name="authorcontact" placeholder="number">
                                            </div>
                                        </div>
                                        <!-- <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-currency">Author Img <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
