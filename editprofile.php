                    ...
                    <ul class="clearfix">
                        ...
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative" data-toggle="dropdown">
                                ...
                                <img src="<?php echo $row['user_img']?>" height="40" width="40" alt="">
                            </div>
        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="nav-label">Edit Profile</li>
                    <li>
                        <a class="has-arrow" href="displaypurchasebooks.php" aria-expanded="false">
                            <i class="icon-envelope menu-ico"></i> <span class="nav-text">Display Purchase Books</span>
                    </a>
                    </li>
                    <!-- <li>
                    ...
                    <li>
                        <a class="has-arrow" href="editprofile.php" aria-expanded="false">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="userupdateaction.php" method="POST"  enctype="multipart/form-data">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username"
                                                    name="username" placeholder="Enter a username.." required value="<?php echo $username?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-email" name="email"
                                                    placeholder="Your valid email.." required value="<?php echo $user_email?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="password" class="form-control" id="val-password"
                                                    name="password" placeholder="Choose a safe one.." required value="<?php echo $user_password?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="number" class="form-control" id="val-confirm-password"
                                                    name="usercontact" placeholder="..and confirm it!" required value="<?php echo $user_contact?>">
                                            </div>
                                        </div>
                                        <!-- <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="file" name="userupdateimge" class="form-control" id="val-currency">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-8 ml-auto">
                                                <button type="submit" name="userupdate" class="btn mb-1 btn-rounded btn-primary">Submit</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
